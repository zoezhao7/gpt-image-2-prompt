...
Data goes into <script type="application/json"> tags.
JS reads via JSON.parse() -> no escaping nightmares.
"""
import json, os
...
styles_json  = json.dumps(styles_list,  ensure_ascii=False)
scenes_json  = json.dumps(scenes_list,  ensure_ascii=False)
